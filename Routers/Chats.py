...
from Service.Methods import get_chat_id, get_chat_name, get_all_chats, get_chat_users, db_connect
...
async def create_chat(chat: Group, owner=Depends(auth_handler.decode)):
    ...
    try:
        ...
        msg = Binary(encrypt(f"Chat created id=g{max_id}".encode("utf-8"), pubkey))
